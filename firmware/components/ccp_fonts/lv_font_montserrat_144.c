 ...
 * Size: 144 px
 * Bpp: 4
 * Opts: --font firmware/managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 144 --bpp 4 --format lvgl --range 0x30-0x3A --no-compress --force-fast-kern-format -o firmware/components/ccp_fonts/lv_font_montserrat_144.c
 ******************************************************************************/
