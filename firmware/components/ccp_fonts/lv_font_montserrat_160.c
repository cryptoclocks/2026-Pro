 ...
 * Size: 160 px
 * Bpp: 4
 * Opts: --font firmware/managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 160 --bpp 4 --format lvgl --range 0x30-0x3A --no-compress --force-fast-kern-format -o firmware/components/ccp_fonts/lv_font_montserrat_160.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1708, .box_w = 93, .box_h = 115, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 5348, .adv_w = 947, .box_w = 42, .box_h = 113, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7721, .adv_w = 1469, .box_w = 85, .box_h = 114, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 12566, .adv_w = 1464, .box_w = 85, .box_h = 114, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 17411, .adv_w = 1713, .box_w = 100, .box_h = 113, .ofs_x = 6, .ofs_y = 0},
    {.bitmap_index = 23061, .adv_w = 1469, .box_w = 85, .box_h = 114, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 27906, .adv_w = 1580, .box_w = 88, .box_h = 115, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 32966, .adv_w = 1531, .box_w = 86, .box_h = 113, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 37825, .adv_w = 1649, .box_w = 89, .box_h = 116, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 42987, .adv_w = 1580, .box_w = 88, .box_h = 116, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 48091, .adv_w = 581, .box_w = 22, .box_h = 87, .ofs_x = 7, .ofs_y = -1}
};
