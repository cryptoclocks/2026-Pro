 ...
 * Size: 112 px
 * Bpp: 4
 * Opts: --font firmware/managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 112 --bpp 4 --format lvgl --range 0x30-0x3A --no-compress --force-fast-kern-format -o firmware/components/ccp_fonts/lv_font_montserrat_112.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef LV_FONT_MONTSERRAT_112
#define LV_FONT_MONTSERRAT_112 1
#endif

#if LV_FONT_MONTSERRAT_112
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_112 = {
#else
lv_font_t lv_font_montserrat_112 = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_112*/
