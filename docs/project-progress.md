...
- ✅ Weather is now a real product: `com.ccp.weather@1.0.0` published (layout + noop wasm, 4.9KB bundle), linked to Store item `weather` (payloadId), grant → download → activate → shows on the clock. Builder has a Weather starter template.
